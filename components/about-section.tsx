        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-slate-800">
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p>
                <strong className="text-slate-800">ברוכים הבאים לאוהל אברהם</strong> – הבית לשיפוצים איכותיים, עבודות
                חשמל, גבס, צבע, התקנות, תיקונים קטנים ותחזוקה כוללת.
              </p>

              <p>
                אנחנו כאן כדי לפתור בעיות, לשדרג חללים ולבצע עבודה כמו שצריך – עם שירות אישי, זמינות גבוהה, מחירים
                הוגנים וליווי אמיתי.
              </p>
